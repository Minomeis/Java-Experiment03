...
public class Student extends entity_first.People {
    private int age;
    //private Course course;
    private entity_first.Course[] c = new entity_first.Course[5];
    private int i;
    ...
    public void add_course(int class_id, entity_first.Course[] C){
        int q = 0;
    ...
    public void adde_course(int class_id, entity_first.Course[] C){
        for(int a=0;a<=C.length;a++) {
            if (C[a] == null) {
                break;
            } else {
    ...
    private void addcourse(entity_first.Course cc){
        c[i] = cc;
        i++;
    }

    public void drop_course(int id){
        entity_first.Course[] d = new entity_first.Course[5];
        int j = 0;
